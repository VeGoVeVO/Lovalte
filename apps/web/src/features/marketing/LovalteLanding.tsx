...
function QrMotif() {
  const cells = ["1110111", "1010101", "1110111", "0001000", "1101011", "1010001", "1110111"];
  return (
    <svg viewBox="0 0 7 7" width="56" height="56" aria-hidden="true" shapeRendering="crispEdges">
      ...
      {cells.flatMap((row, y) =>
        row
          ...
          .map((c, x) =>
            c === "1" ? (
              <rect key={`${x}-${y}`} x={x} y={y} width="1" height="1" fill="#20242A" />
            ) : null,
          ),
      )}
    </svg>
...
const FEATURES = [
  {
    d: "M3 7h18v10a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7zm0 0l2-3h14l2 3M16 12h3",
  ...
  },
  {
    ...
    title: "One QR to scan",
    body: "Staff scan a customer's pass to award or redeem points. No app for them, no extra hardware for you.",
  },
  {
    d: "M4 19V5m0 14h16M8 16V11m4 5V8m4 8v-3",
              ...
              <div className="hero-wrap">
                <div className="hero-copy">
                  ...
                  <h1 className="hero" id="hero-title">
                    {t("Loyalty cards your customers actually keep.")}
                  </h1>
                  <p className="lead">
                    {t(
            ...
            <div className="container">
              <Reveal className="section-head">
                ...
                <h2 className="section" id="features-title">
                  {t("A loyalty program your customers love.")}
                </h2>
              </Reveal>
          ...
          <section id="how" aria-labelledby="how-title">
            <div className="container">
              <Reveal className="section-head">
                ...
                <h2 className="section" id="how-title">
              ...
              <Reveal className="grid-3">
                {STEPS.map((s) => (
                  <GlassCard light className="feature" key={s.n}>
                    <span className="ico" aria-hidden="true" style={{ fontWeight: 600 }}>
                      {s.n}
                    </span>
            ...
            <div className="container">
              <Reveal>
                <GlassCard light className="waitlist">
                  ...
                  <h2 className="section" id="start-title">
                    {t("Start your loyalty program.")}
                  </h2>
