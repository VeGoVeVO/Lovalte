...
export const features = [
  ...
  {
    icon: Icon.Presence,
    title: "Senses the room",
    body: "It softens when you leave and breathes back to life when you return. The light is just there when you need it. No app, no tapping.",
  },
  {
    icon: Icon.Glass,
