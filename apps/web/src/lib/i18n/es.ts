...
export const ES: Record<string, string> = {
  ...
  // Click-to-edit popovers + Apple field coverage
  ...
  "Back of the card": "Reverso de la tarjeta",
  "Back ({n})": "Reverso ({n})",
  "Add field": "Añadir campo",
  "Maximum {n} reached.": "Máximo {n} alcanzado.",
  Photo: "Foto",
  "Top-left of the card.": "Arriba a la izquierda de la tarjeta.",
  "Banner behind the value.": "Banner detrás del valor.",
  "Drag the image on the card to reposition.": "Arrastra la imagen en la tarjeta para recolocarla.",
  "e.g. POINTS": "p. ej. PUNTOS",
  Fewer: "Menos",
  ...
  "Tell us what's going on and we'll get back to you here.":
    "Cuéntanos qué pasa y te respondemos aquí.",
  "e.g. My loyalty cards aren't scanning": "p. ej. Mis tarjetas de fidelidad no se escanean",
  "Describe the issue in as much detail as you can…":
    "Describe el problema con todo el detalle que puedas…",
  "Submit ticket": "Enviar ticket",
  "Could not create the ticket": "No se ha podido crear el ticket",
  "Ticket conversation": "Conversación del ticket",
  "Back to tickets": "Volver a los tickets",
  "Could not load this ticket.": "No se ha podido cargar este ticket.",
  "This ticket is closed. Open a new ticket if you still need help.":
    "Este ticket está cerrado. Abre uno nuevo si aún necesitas ayuda.",
  "This ticket is closed. Change the status above to reply.":
    "Este ticket está cerrado. Cambia el estado arriba para responder.",
  "Your reply": "Tu respuesta",
  "Write a reply…": "Escribe una respuesta…",
  "Send reply": "Enviar respuesta",
  "Support replied": "Soporte respondió",
  "Could not load your tickets.": "No se han podido cargar tus tickets.",
  "No tickets yet": "Aún no hay tickets",
  "Open your first ticket and we'll help you out.": "Abre tu primer ticket y te ayudamos.",
  "Your conversations": "Tus conversaciones",
  "Select a ticket to read the thread, or open a new ticket.":
    "Selecciona un ticket para leer la conversación, o abre uno nuevo.",
  "Manage ticket": "Gestionar ticket",
  "From {email}": "De {email}",
  "opened {when}": "abierto {when}",
  "Reply as Support": "Responder como Soporte",
  "Write a reply to the customer…": "Escribe una respuesta al cliente…",
  "Customer replied": "El cliente respondió",
  "Filter by status": "Filtrar por estado",
  "Search subject or email…": "Buscar por asunto o correo…",
  "Search tickets": "Buscar tickets",
  "Could not load tickets.": "No se han podido cargar los tickets.",
  "No tickets match this view.": "No hay tickets en esta vista.",
  "Select a ticket to read the thread and reply.":
    "Selecciona un ticket para leer la conversación y responder.",
};
